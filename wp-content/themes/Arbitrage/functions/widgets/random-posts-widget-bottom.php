...
/*
Plugin Name: Lipode Random Posts Widget Bottom
Description: A widget that displays random posts with thumbnails at bottom of the page.
Version: 1.0
*/

class Lipode_Random_Posts_Widget_Bottom extends WP_Widget {
	...
	function Lipode_Random_Posts_Widget_Bottom () {
		
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'random-posts-widget-bottom', 'description' => __( 'A widget that displays random posts with thumbnails at bottom of the page.', 'Lipode' ) );

		/* Widget control settings. */
		$control_ops = array( 'id_base' => 'random-posts-widget-bottom' );

		/* Create the widget. */
		parent::__construct( 'random-posts-widget-bottom', __('Lipode Random Posts Widget Bottom', 'Lipode' ), $widget_ops, $control_ops );
	...
	function form ( $instance ) {
		...
		$defaults = array( 'title' => __( 'Stories You May Like', 'Lipode' ), 'number' => '6' );
...
add_action( 'widgets_init', create_function( '', 'return register_widget("Lipode_Random_Posts_Widget_Bottom");' ), 1 );
